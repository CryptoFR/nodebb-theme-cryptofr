	...
	<ul class="dropdown-menu pull-right">
		<li>
			<a component="topic/mark-unread-for-all" href="#">
				<i class="fad fa-envelope"></i> [[topic:thread_tools.markAsUnreadForAll]]
			</a>
		</li>
		<li>
		...
		<li>
			<a component="topic/lock" href="#">
				<i class="fad fa-lock"></i> [[topic:thread_tools.lock]]
			</a>
		</li>
		<li>
			<a component="topic/unlock" href="#" class="hidden">
				<i class="fad fa-unlock"></i> [[topic:thread_tools.unlock]]
			</a>
		</li>
		...
		<li>
			<a component="topic/merge" href="#">
				<i class="fa fa-fw fa-compress-arrows-alt"></i> [[topic:thread_tools.merge]]
			</a>
		</li>
		...
		<li>
			<a component="topic/delete" href="#">
				<i class="fad fa-trash"></i> [[topic:thread_tools.delete]]
			</a>
		</li>
		<li>
			<a component="topic/restore" href="#" class="hidden">
				<i class="fad fa-trash-undo-alt"></i> [[topic:thread_tools.restore]]
			</a>
		</li>
		<li>
			<a component="topic/purge" href="#" class="hidden">
				<i class="fad fa-eraser"></i> [[topic:thread_tools.purge]]
			</a>
		</li>
