...
<div class="clearfix post-footer">
	...
	<small class="pull-left post-actions">
		...
		<span class="post-tools">
			<a component="post/reply" href="#" class="no-select <!-- IF !privileges.topics:reply -->hidden<!-- ENDIF !privileges.topics:reply -->"><i class="fad fa-reply"></i> [[topic:reply]]</a>
			<a component="post/quote" href="#" class="no-select <!-- IF !privileges.topics:reply -->hidden<!-- ENDIF !privileges.topics:reply -->"><i class="fad fa-quote-right"></i> [[topic:quote]]</a>
		</span>
	</small>
