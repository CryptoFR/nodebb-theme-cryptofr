<li component="categories/category" data-cid="{../cid}" data-numRecentReplies="1" class="row clearfix">
	...
	<div class="content col-xs-9 <!-- IF config.hideCategoryLastPost -->col-md-10 col-sm-12<!-- ELSE -->col-md-6 col-sm-9<!-- ENDIF config.hideCategoryLastPost -->">
	...
	<div class="col-md-4 col-sm-3 col-xs-3 teaser {../unread-class}" component="topic/teaser">
