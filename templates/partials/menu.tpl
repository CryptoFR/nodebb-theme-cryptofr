			<div class="navbar-header">
				<button type="button" class="navbar-toggle pull-left" id="mobile-menu">
					<span component="notifications/icon" class="notification-icon fa fa-bell-o unread-count" data-content="{unreadCount.notification}"></span>
					<i class="fas fa-lg fa-bars"></i>
				</button>
				<button type="button" class="navbar-toggle hidden" id="mobile-chats">
					<span component="chat/icon" class="notification-icon fas fa-comments unread-count" data-content="{unreadCount.chat}"></span>
			...
			<div id="nav-dropdown" class="hidden-xs">
				...
				<ul id="logged-in-menu" class="nav navbar-nav navbar-right">
					<li class="notifications dropdown text-center hidden-xs" component="notifications">
						<a href="{relative_path}/notifications" title="[[global:header.notifications]]" class="dropdown-toggle" data-toggle="dropdown" id="notif_dropdown" data-ajaxify="false" role="button">
							<i component="notifications/icon" class="fa fa-bell-o unread-count" data-content="{unreadCount.notification}"></i>
						</a>
				...
				<ul id="logged-out-menu" class="nav navbar-nav navbar-right">
					...
					<li>
						<a href="{relative_path}/login" class="login-button">
				...
				<ul id="main-nav" class="nav navbar-nav">
					...
					<li class="{navigation.class}">
						<a class="navigation-link" href="{navigation.route}" title="{navigation.title}" <!-- IF navigation.id -->id="{navigation.id}"<!-- ENDIF navigation.id --><!-- IF navigation.properties.targetBlank --> target="_blank"<!-- ENDIF navigation.properties.targetBlank -->>
							...
							<i class="fas fa-fw {navigation.iconClass}" data-content="{navigation.content}"></i>
